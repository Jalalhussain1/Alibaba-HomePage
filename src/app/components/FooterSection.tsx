            ...
            <Container maxWidth="xl">
                ...
                <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1, mb: 4 }}>
                    {footerSections.map((section, index) => (
                        ...
                        >
                            <Typography variant="h6" sx={{ fontWeight: 600, color: "#333", mb: 2, fontSize: "1rem" }}>
                                {section.title}
                            </Typography>
                ...
                >
                    ...
                    <Box sx={{ display: "flex", gap: 2 }}>
                        {[Facebook, LinkedIn, Twitter, Instagram, YouTube].map((Icon, i) => (
                            <IconButton key={i} sx={{ color: "#666", "&:hover": { color: "#1976d2" } }}>
                                <Icon />
                            </IconButton>
                        ))}
                        <Box
                    ...
                    <Box sx={{ display: "flex", flexDirection: { xs: "column", sm: "row" }, alignItems: "center", gap: 2 }}>
                        ...
                        <Box sx={{ display: "flex", gap: 1 }}>
                            <Button variant="contained" sx={{ backgroundColor: "#000", color: "#fff", fontSize: "0.75rem", px: 2, py: 1, borderRadius: 2 }}>
                                📱 App Store
                            </Button>
                            <Button variant="contained" sx={{ backgroundColor: "#000", color: "#fff", fontSize: "0.75rem", px: 2, py: 1, borderRadius: 2 }}>
                                📱 Google Play
                    ...
                    <Box sx={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: 1 }}>
                        {alibabaServices.map((service, i) => (
                            <Box key={i} sx={{ display: "flex", alignItems: "center" }}>
                                <Link href="#" sx={{ color: "#666", fontSize: "0.875rem", textDecoration: "none", "&:hover": { textDecoration: "underline", color: "#1976d2" } }}>
                                    {service}
                                </Link>
                ...
                <Box sx={{ textAlign: "center", pt: 2, }}>
                    <Typography variant="body2" sx={{ fontSize: "0.75rem", }}>
                        © 1999-2025 Alibaba.com. 版权所有：杭州阿里巴巴海外科技有限公司 增值电信业务经营许可证：浙B2-20241358
                    </Typography>
